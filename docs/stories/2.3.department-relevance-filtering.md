...
- [ ] **Task 1: Load User Research Profile** (AC: 1)
  - [ ] Load consolidated profile from `output/user-profile.md` (from Story 1.7)
...
- [ ] **Task 2: Implement LLM-Based Relevance Filtering** (AC: 1, 2, 3)
  - [ ] Use `llm_helpers.py` prompt template for department filtering (Story 1.4)
  - [ ] Prompt template:
    ```
...
- [ ] **Task 5: Log All Filtering Decisions** (AC: 4)
  - [ ] Use structured logger from Story 1.4
  - [ ] Log format:
    ```json
    {
