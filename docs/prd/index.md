...
- [Lab Finder Product Requirements Document (PRD)](#table-of-contents)
  ...
  - [Epic Details](./epic-details.md)
    ...
    - [Epic 6: LinkedIn Integration & PhD Position Detection](./epic-details.md#epic-6-linkedin-integration-phd-position-detection)
      - [Story 6.1: Shared Playwright Session Management](./epic-details.md#story-61-shared-playwright-session-management)
      - [Story 6.2: Subagent Queue for LinkedIn Access](./epic-details.md#story-62-subagent-queue-for-linkedin-access)
      - [Story 6.3: LinkedIn Profile Matching with Confidence Scores](./epic-details.md#story-63-linkedin-profile-matching-with-confidence-scores)
      - [Story 6.4: PhD Graduation & Departure Detection](./epic-details.md#story-64-phd-graduation-departure-detection)
      - [Story 6.5: LinkedIn Error Handling & Logging](./epic-details.md#story-65-linkedin-error-handling-logging)
